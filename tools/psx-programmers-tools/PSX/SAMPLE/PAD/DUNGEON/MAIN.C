...
#define ACT_VAIB_MAX	(255)	/* アクチュエータ振動上限値 */
#define ACT_VAIB_MIN	(100)	/* アクチュエータ振動停止下限値 */
#define ACT_VAIB_HIT	(120)	/* アクチュエータ振動停止下限値 */
#define ACT_LOW_IDLE	(0)	/* アクチュエータの常時振動値 */
...
int texture_init(long* addr)
{
	...
	if ((tim1.pmode>>3)&0x01) {
		...
		rect.w=tim1.cw;	/* クラットの幅 */
		rect.h=tim1.ch;	/* クラットの高さ */
		/* クラットをロードする */
