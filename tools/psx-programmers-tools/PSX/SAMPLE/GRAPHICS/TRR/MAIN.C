...
CVECTOR *c;
{
	...
	case 2:
		...
		otz=
		TransRotPers3(&sv[0],&sv[1],&sv[2],(long*)&s->x0,(long*)&s->x1,(long*)&s->x2,&p,&flg);
		...
		/*Transfer&Rotate 3 vertices*/ 
		otz=
		TransRotPers3(&sv[0],&sv[2],&sv[3],(long*)&s->x0,(long*)&s->x1,(long*)&s->x2,&p,&flg);
	...
	case 1:
		...
		/*Transfer&Rotate 3 vertices*/ 
		otz=
		TransRotPers(&sv[0],(long*)&s->x0,&p,&flg);
		TransRotPers(&sv[1],(long*)&s->x1,&p,&flg);
		TransRotPers(&sv[2],(long*)&s->x2,&p,&flg);
		...
		otz=
		TransRotPers(&sv[0],(long*)&s->x0,&p,&flg);
		TransRotPers(&sv[2],(long*)&s->x1,&p,&flg);
		TransRotPers(&sv[3],(long*)&s->x2,&p,&flg);
