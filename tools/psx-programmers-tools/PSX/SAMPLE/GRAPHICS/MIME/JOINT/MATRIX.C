...
static long preVectorNormal(VECTOR *v);
            			...
            			/* t: Eigen Vector */
{
    ...
    sm[1] = me.m[1][0]*me.m[2][2] - me.m[1][2]*me.m[2][0];
    ...
    sm[6] = me.m[0][1]*me.m[1][2] - me.m[0][2]*me.m[1][1];
...
/* !! v0 value will be changed !! */
long newVectorNormal(VECTOR *v0, VECTOR *v1)
{
    long a,b,c,d;
    long r;
    VECTOR v2;
