...
#define SEED_X	320		/* X 初期座標  */
#define SEED_Y	450		/* Y 初期座標  */
#define ORDER 8			/* 枝別れ回数  */
#define LENGTH 120.0    	/* 最初の枝のの長さ */
#define ANGLE 0.0		/* 最初の枝の角度 */
#define FACTOR 0.75		/* 枝の長さの変化率 */
#define TURN 0.4		/* 枝の曲率 */
