...
*/
/*	ここでのサンプルでは、高レベル関数の使用例が示されます。
 *	高レベル関数では基本的な CD-ROM の機能を簡単に使用することがで
 *	きます。
 */
...
static void read_test( char* file )
{
	...
	for( i = 0; i < 2; i++ ) {
		if( DsReadFile( file, buf[ i ], MAXSECTOR * 2048 ) == 0 ) {
