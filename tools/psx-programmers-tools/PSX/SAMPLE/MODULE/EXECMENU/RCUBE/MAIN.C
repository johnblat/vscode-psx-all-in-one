 ...
 *		Version 3.02b	Aug, 3, 1995 yoshi (for EXEC)
 *		Version 3.02c	Mar, 4, 1996 yoshi (added English comment)
 *
...
/* テクスチャ情報 */
#define TIM_ADDR 0x80108000		/* 使用するTIMファイルの格納アドレス */
/*#define TIM_ADDR 0x80020000	/* 使用するTIMファイルの格納アドレス */
#define TIM_HEADER 0x00000010

/* モデリングデータ情報 */
#define TMD_ADDR 0x80100000		/* 使用するTMDファイルの格納アドレス */
...
PACKET GpuPacketArea[2][PACKETMAX*64];	/* Oパケット領域（ダブルバッファ） */
...
#ifdef CDREAD	/* CDREADを定義していない時は、あらかじめPQBLOADで
			       データをダウンロードしておいて下さい */
